...
if(isset($_POST['delete'])){
   ...
   if($verify_delete->rowCount() > 0){
      ...
      $warning_msg[] = 'usuário já deletado!';
   }
...
<section class="grid">
   ...
   <div class="box" style="text-align: center;">
      <p>crie um novo usuário de acesso</p>
      <a href="register.php" class="btn">registre agora</a>
   </div>
   ...
   <div class="box" <?php if( $fetch_admins['name'] == 'admin'){ echo 'style="display:none;"'; } ?>>
      ...
      <form action="" method="POST">
         ...
         <input type="submit" value="delete admins" onclick="return confirm('deseja deletar esse usuário?');" name="delete" class="btn">
      </form>
   </div>
   <?php
      }
