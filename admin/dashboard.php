...
<section class="dashboard">
   ...
   <div class="box">
      ...
      <a href="update.php" class="btn">Mudar a senha</a>
   </div>
   ...
   <div class="box">
      ...
      <a href="bookings.php" class="btn">Visualizar reservas</a>
   </div>
   ...
   <div class="box">
      ...
      <a href="admins.php" class="btn">Visualizar usuários</a>
   </div>
   ...
   <div class="box">
      ...
      <a href="messages.php" class="btn">Visualizar Mensagens</a>
   </div>
   ...
   <div class="box">
      ...
      <a href="register.php" class="btn" style="margin-left: 1rem;">registro</a>
   </div>
