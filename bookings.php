...
<section class="bookings">
   ...
   <div class="box">
      ...
      <p>número : <span><?= $fetch_booking['number']; ?></span></p>
      <p>entrada : <span><?= $fetch_booking['check_in']; ?></span></p>
      <p>saída : <span><?= $fetch_booking['check_out']; ?></span></p>
      <p>quartos : <span><?= $fetch_booking['rooms']; ?></span></p>
      <p>adultos : <span><?= $fetch_booking['adults']; ?></span></p>
      <p>crianças : <span><?= $fetch_booking['childs']; ?></span></p>
      <p>código de reserva : <span><?= $fetch_booking['booking_id']; ?></span></p>
      <form action="" method="POST">
         <input type="hidden" name="booking_id" value="<?= $fetch_booking['booking_id']; ?>">
         <input type="submit" value="cancelar reserva" name="cancel" class="btn" onclick="return confirm('deseja cancelar a reserva?');">
      </form>
   </div>
   <?php
    }
   ...
   <div class="box" style="text-align: center;">
      <p style="padding-bottom: .5rem; text-transform:capitalize;">nenhuma reserva encontrada!</p>
      <a href="index.php#reservation" class="btn">nova reserva</a>
   </div>
   <?php
   }
   ?>
